...
<p style="font-size: 22px; color: #fff8dc; margin: 14px 0; line-height: 1.5;">生命中所有的灿烂，终究要用寂寞去偿还。</p>
<p style="font-size: 16px; color: #8fa4d3;">— 《百年孤独》</p>
...
|------------|-------------|-------|
| [codecrafters-io/build-your-own-x](https://github.com/codecrafters-io/build-your-own-x) | Master programming by recreating your favorite technolo... | ⭐ 517,136 |
| [sindresorhus/awesome](https://github.com/sindresorhus/awesome) | 😎 Awesome lists about all kinds of interesting topics | ⭐ 476,899 |
| [freeCodeCamp/freeCodeCamp](https://github.com/freeCodeCamp/freeCodeCamp) | freeCodeCamp.org's open-source codebase and curriculum.... | ⭐ 449,596 |
| [public-apis/public-apis](https://github.com/public-apis/public-apis) | A collective list of free APIs | ⭐ 442,625 |
<!-- TRENDING-REPOS-END -->
